  ...
  return (
    <div className="flex-1 min-h-[100vh] pb-[15vh] relative">
      ...
      <div className="max-w-[900px] m-auto">
        {!displayResult ? (
            ...
            <div className="my-12 text-5xl font-medium p-5">
              <p>
                <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                  Hello, Mr. Sunil Gupta
                </span>
              </p>
              {/* <p>Hi , I am Stark Ai with Power of Gemini</p> */}
            </div>
          ...
          <div className="result">
            ...
            <div className="flex items-start gap-5">
              <img src="/logo1.png" className="h-[60px] w-[60px] rounded-sm mt-[-18px] drop-shadow-[1px_1px_6px_white]" alt="" />
              <p
        ...
        <div className="absolute bottom-0 w-full max-w-[900px] px-5 m-auto mb-10 ">
          <form action={submit}>
            <div className="flex items-center justify-between gap-5 bg-bgSecondaryColor py-2.5 px-5 rounded-full  border border-blue-600 solid">
              <input
              ...
              <div className="flex cursor-pointer ">
                <SendHorizontal type="submit" size={30} />
              </div>
            </div>
          </form>
